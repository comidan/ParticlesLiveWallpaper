...
public class ParticlesLiveWallpaper extends PApplet {
...
class Mover
{
  ...
  public void setRandomColor ()
  {
    ...
    if (colorDice == 0) c = 0xffffedbc;
    else if (colorDice == 1) c = 0xffA75265;
    else if (colorDice == 2) c = 0xffec7263;
    else c = 0xfffebe7e;
  }
...
public void mousePressed ()
{
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "ParticlesLiveWallpaper" };
    if (passedArgs != null) {
